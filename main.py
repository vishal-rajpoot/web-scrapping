...
response = requests.get(url) #HERE WHEN OUR REQUEST GETS APPROVED AND WE WILL GET RESPONSE FROM THE SERVER OF THE GIVEN URL 
...
with open(filename, "w+") as f:  # HERE "with" KEYWORD IS USED FOR AUTOMATICALLY OPEN THE FILE USING "open() FUNCTION AS A WRITEABLE MODE.
